...
// ── Paste your Instagram embed codes here ────────────────────────────────────
// Each object needs: id (unique), permalink, and the full blockquote HTML
const POSTS = [
  {
    id: "DZhDmwGupOz",
    permalink: "https://www.instagram.com/reel/DZhDmwGupOz/",
  },
  {
    id: "DZwb_hkOtBZ",
    permalink: "https://www.instagram.com/reel/DZwb_hkOtBZ/",
  },
  {
    id: "DYo8TzFOh0p",
    permalink: "https://www.instagram.com/reel/DYo8TzFOh0p/",
  },
  {
    id: "DYW09S7OSFv",
    permalink: "https://www.instagram.com/reel/DYW09S7OSFv/",
  },
  {
    id: "DXO4U2fDh-h",
    permalink: "https://www.instagram.com/reel/DXO4U2fDh-h/",
  },
  {
    id: "DV0rYmYDsLQ",
    permalink: "https://www.instagram.com/reel/DV0rYmYDsLQ/",
  },
  {
    id: "DUIlceejk-E",
    permalink: "https://www.instagram.com/reel/DUIlceejk-E/",
  },
  {
    id: "DUaks5ADj1v",
    permalink: "https://www.instagram.com/reel/DUaks5ADj1v/",
  },
];

// Social icon buttons (top right) — matching the reference screenshot
const SOCIAL_LINKS = [
  {
    label: "Facebook",
    href: "#",
...
// ── Instagram thumbnail (uses the og:image trick via a proxy) ────────────────
// We use the public thumbnail from Instagram's CDN via the post ID
function IgThumb({ postId, onClick }) {
  const ref = useRef(null);
  const inView = useInView(ref, { once: true, margin: "-30px" });

  // Instagram reels thumbnail URL pattern
  const thumbUrl = `https://www.instagram.com/p/${postId}/media/?size=m`;
  ...
  return (
    ...
    >
      ...
      >
        {/* Instagram icon bottom-right (like Lays) */}
      </motion.div>

      {/* Instagram icon — always visible bottom right */}
      <div style={{
        position: "absolute",
        bottom: 8,
        right: 8,
...
// ── Modal: shows the real Instagram embed ────────────────────────────────────
function IgModal({ postIndex, posts, onClose }) {
  ...
  // Re-process Instagram embed script each time post changes
  useEffect(() => {
    if (!embedRef.current) return;

    // Remove any previously loaded embeds
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          ref={embedRef}
          style={{ padding: "8px 0 0", clear: "both" }}
        />
      </motion.div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Social icon pills — top right, matching screenshot */}
        <motion.div
          initial={{ opacity: 0, x: 40 }}
          animate={headerInView ? { opacity: 1, x: 0 } : {}}
      ...
      {/* ── 4-column grid — exactly like the Lays screenshot ── */}
      <div
        style={{
          display: "grid",
          gridTemplateColumns: "repeat(4, 1fr)",
          gap: 3,
          padding: "0",          // full-bleed grid like Lays
        }}
      >
        {POSTS.map((post, i) => (
          <IgThumb
